                        ...
                        <Grid stackable>
                            ...
                            <GridColumn width={7}>
                                <Form.Field>
                                    ...
                                    <input name="startYear" type="number" value={values.startYear} onChange={handleChange} />
                                    {
                            ...
                            <GridColumn width={7}>
                                <Form.Field>
                                    ...
                                    <input name="graduationYear" type="number" value={values.graduationYear} onChange={handleChange} />
                                    {
